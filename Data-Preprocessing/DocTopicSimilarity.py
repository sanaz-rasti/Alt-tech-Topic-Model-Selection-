...
def main():
    chd = ChannellData(datapath=r'C:\Users\UCD\Desktop\Topic Modeling\data\TelegramData.db',
                       target_table="Telegram_Channel_strippedText_Processed_PluralChecked",
                       channelUniqueId='252TC-1001250192398')
